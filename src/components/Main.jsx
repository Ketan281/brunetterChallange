...
const Main = ({ onLogout }) => {
  ...
  const creators = [
    ...
    { name: "Harsh", bio: "Harsh is a newbie to web3 and is trying to bring off chain creators onchain. p.s. he’s CTO of Qyuki our sponsors for tonight! 😜", photo: harsh,gen:"m",username:"0xSongra" },
